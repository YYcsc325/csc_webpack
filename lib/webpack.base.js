...
module.exports = {
  ...
  resolve: {
    ...
    // 别名
    alias: {
      '~container': path.join(projectRoot, 'src/index/container'),
      '~components': path.join(projectRoot, 'src/index/components'),
      '~utils': path.join(projectRoot, 'src/index/utils'),
      '~serve': path.join(projectRoot, 'src/index/serve'),
    },
  },
  plugins: [

...
module.exports = {
  ...
  resolve: {
    ...
    // 别名
    alias: {
      '@dep': path.join(projectUrl, 'src/deploy'),
      '@con': path.join(projectUrl, 'src/container'),
      '@actions': path.join(projectUrl, 'src/redux/actions'),
      '@reducers': path.join(projectUrl, 'src/redux/reducers'),
    },
  },
  plugins: [
